        ...
        <div class="aboutus" id="aboutus">
            <div class="container">
                ...
                <div class="row">
                    <div class="col-lg-6">
                        <div class="subtitle">
                            <?php the_field('block_title_1'); ?>
                        </div>
                        <div class="aboutus__text">
                            <?php the_field('block_text_1'); ?>
                        </div>
                    </div>
                    <div class="col-lg-6">
                        <img class="aboutus__img" src="<?php the_field('block_img_1'); ?>" alt="мир детства">
                    </div>
                </div>

                <div class="row">
                    <div class="col-lg-6">
                        <img class="aboutus__img" src="<?php the_field('block_img_2'); ?>" alt="мир детства">
                    </div>
                    <div class="col-lg-6">
                        <div class="subtitle">
                            <?php the_field('block_title_2'); ?>
                        </div>
                        <div class="aboutus__text">
                ...
                <div class="row">
                    <div class="col-lg-6">
                        <div class="subtitle">
                            <?php the_field('block_title_3'); ?>
                        </div>
                        <div class="aboutus__text">
                            <?php the_field('block_text_3'); ?> 
                        </div>
                    </div>
                    <div class="col-lg-6">
                        <img class="aboutus__img" src="<?php the_field('block_img_3'); ?>" alt="мир детства">
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="container">
                ...
                <div class="row mt70">
                    <div class="col-lg-8 offset-lg-2">
                        <div class="title"> <?php the_field('feedback_title'); ?> </div>
