...
<div class="question">
        ...
        <div class="reply">
            <div class="reply__body">
                <div class="reply__title">
                  ...
                  <?php echo do_shortcode('[contact-form-7 id="158" title="Форма модального окна"]'); ?>
            </div>
        </div>
        <footer>
            <div class="container">
        ...
        <script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyDhUkngd-5EeXp8I9wN2PEmyRclTiP8A_k"></script> // Ваш ключ Google API 
